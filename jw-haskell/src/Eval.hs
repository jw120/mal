...
apply envRef astList = do
    ...
    case astList of
        ...
        [ASTSym "def!", ASTSym sym, val] -> do
            ...
            return val'
        (ASTSym "def!" : _) -> throwError "Bad syntax in def! special form"
        ...
        (ASTSym "defmacro!" : _) -> throwError "Bad syntax in defmacro! special form"

        -- Special form: do
        [ASTSym "do"] -> throwError "No arguments for do special form"
        ...
        (ASTSym "fn*" : _) -> throwError "Bad syntax in fn* special form"
        ...
        (ASTSym "if" : _) -> throwError "Bad syntax in if special form"
        ...
        (ASTSym "let*" : _) -> throwError "Bad syntax in let* special form"

        -- Special form: macroexpand
        [ASTSym "macroexpand", ast] -> macroExpand envRef ast
        (ASTSym "macroexpand" : _) -> throwError "Bad syntax in macroexpand special form"

        -- Special form: quote
        [ASTSym "quote", val] -> return val
        (ASTSym "quote" : _) -> throwError "Bad syntax in quote special form"
        ...
        (ASTSym "quasiquote" : _) -> throwError "Bad syntax in quasiquote special form"
        ...
        [] -> throwError "Unexpected empty list in apply"

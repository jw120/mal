...
mal mal_is_nil(list_node *n, env *e) {
...
mal mal_is_true(list_node *n, env *e) {
  DEBUG_HIGH_MAL("called with", mal_list(n));
  if (list_count(n) != 1)
...
mal mal_is_false(list_node *n, env *e) {
  DEBUG_HIGH_MAL("called with", mal_list(n));
  if (list_count(n) != 1)
...
mal mal_is_sym(list_node *n, env *e) {
  DEBUG_HIGH_MAL("called with", mal_list(n));
  if (list_count(n) != 1)
...
mal mal_is_kw(list_node *n, env *e) {
  DEBUG_HIGH_MAL("called with", mal_list(n));
  if (list_count(n) != 1)
...
mal mal_is_vec(list_node *n, env *e) {
  DEBUG_HIGH_MAL("called with", mal_list(n));
  if (list_count(n) != 1)
...
mal mal_is_seq(list_node *n, env *e) {
  DEBUG_HIGH_MAL("called with", mal_list(n));
  if (list_count(n) != 1)
...
mal mal_is_map(list_node *n, env *e) {
  DEBUG_HIGH_MAL("called with", mal_list(n));
  if (list_count(n) != 1)
...
void add_is(env *e) {
  env_set(e, "nil?", mal_fn(mal_is_nil));
  env_set(e, "true?", mal_fn(mal_is_true));
  env_set(e, "false?", mal_fn(mal_is_false));
  env_set(e, "symbol?", mal_fn(mal_is_sym));
  env_set(e, "keyword?", mal_fn(mal_is_kw));
  env_set(e, "vector?", mal_fn(mal_is_vec));
  env_set(e, "sequential?", mal_fn(mal_is_seq));
  env_set(e, "map?", mal_fn(mal_is_map));
}
